...
import 'package:kerlos_sherif/features/skills/presentation/views/widgets/skills_mob_grid_view_builder_body.dart';

import '../../../../../core/widgets/custom_firestore_gridview_builder.dart';
import '../../../data/models/skill_model.dart';

class SkillsMobileBody extends StatelessWidget {
  const SkillsMobileBody({super.key, required this.skillsStyle, required this.sizedBoxHeight});
      ...
      child: Column(
        ...
        children: [
          ...
          CustomFirestoreGridViewBuilder<Skill>(
            ...
            itemBuilder: (skill) => SkillsMobGridViewBuilderBody<Skill>(
              data: skill,
